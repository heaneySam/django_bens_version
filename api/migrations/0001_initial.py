...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='coverage',
            constraint=django.contrib.postgres.constraints.ExclusionConstraint(expressions=[('buyer_id', '='), ('underwriting_entity_id', '='), ('period', '&&')], name='no_overlap_per_buyer_entity'),
        ),
        migrations.AddIndex(
            model_name='risk',
